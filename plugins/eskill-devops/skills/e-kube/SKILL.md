...
- **e-deploy** (eskill-devops): Follow up with e-deploy after this skill to validate that generated manifests meet deployment requirements.
- **e-monitor** (eskill-devops): Follow up with e-monitor after this skill to add observability to the generated Kubernetes workloads.
