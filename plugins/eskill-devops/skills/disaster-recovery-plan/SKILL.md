...
- **backup-workflow** (eskill-system): Run backup-workflow before this skill to establish the backup procedures referenced in the recovery plan.
- **monitoring-config** (eskill-devops): Run monitoring-config before this skill to ensure alerting is in place for disaster detection.
