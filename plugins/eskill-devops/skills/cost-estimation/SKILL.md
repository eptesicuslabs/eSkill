...
- **terraform-module-review** (eskill-devops): Run terraform-module-review before this skill to understand the infrastructure components being estimated.
- **infrastructure-review** (eskill-devops): Run infrastructure-review alongside this skill to correlate cost estimates with infrastructure design decisions.
