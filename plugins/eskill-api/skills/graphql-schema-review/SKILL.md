...
- This skill reviews the schema definition. It does not execute queries or test resolvers. For resolver testing, use the contract-test-generator skill.
- For REST API specifications, use the openapi-validator skill instead.
...
- **api-surface-map** (eskill-coding): Run api-surface-map before this skill to identify all GraphQL endpoints and their usage patterns.
- **code-standards** (eskill-quality): Run code-standards alongside this skill to enforce naming and structural conventions in the GraphQL schema.
