...
Use `filesystem` tools (list_directory, read_file) to determine the Storybook setup:
...
- **component-scaffold** (eskill-frontend): Run component-scaffold before this skill to create the components that Storybook stories will document.
- **visual-regression-setup** (eskill-testing): Follow up with visual-regression-setup after this skill to add visual regression tests for the new stories.
