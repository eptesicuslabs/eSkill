...
3. Write the file using `fs_write` to the specified output path.
...
- **e-diagram** (eskill-office): Run e-diagram before this skill to generate diagrams that can be embedded in the report.
- **e-pipe** (eskill-office): Run e-pipe before this skill to prepare the data that the report will present.
