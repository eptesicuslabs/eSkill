...
- **api-surface-map** (eskill-coding): Run api-surface-map before this skill to identify all API endpoints that need documentation.
- **openapi-validator** (eskill-api): Follow up with openapi-validator after this skill to verify generated docs conform to OpenAPI standards.
