...
- **monitoring-config** (eskill-devops): Run monitoring-config before this skill to reference configured alerts and dashboards in the runbook.
- **disaster-recovery-plan** (eskill-devops): Run disaster-recovery-plan alongside this skill to align runbook procedures with the recovery plan.
