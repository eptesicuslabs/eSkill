...
Use `system_processes` to retrieve the list of running processes and their network connections.
...
- **process-analysis** (eskill-system): Run process-analysis before this skill to identify the processes that are causing port conflicts.
- **container-dashboard** (eskill-system): Run container-dashboard before this skill to check whether containerized services are involved in the port conflict.
