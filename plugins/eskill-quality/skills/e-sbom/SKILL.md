...
```json
{
  ...
  "metadata": {
    "timestamp": "<ISO 8601>",
    "tools": [{ "name": "eskill-e-sbom", "version": "1.0.0" }],
...
- **e-deps** (eskill-coding): Run e-deps before this skill to gather the dependency data that feeds into the SBOM.
- **e-license** (eskill-quality): Run e-license before this skill to include license classifications in the generated SBOM.
- **e-comply** (eskill-quality): Follow up with e-comply after this skill to verify the SBOM satisfies regulatory requirements.
