...
- **e-scan** (eskill-quality): Run e-scan before this skill to generate the vulnerability findings referenced in compliance checks.
- **e-sbom** (eskill-quality): Run e-sbom before this skill to provide the software inventory required by compliance frameworks.
- **e-config** (eskill-quality): Run e-config alongside this skill to verify that system configurations meet compliance requirements.
