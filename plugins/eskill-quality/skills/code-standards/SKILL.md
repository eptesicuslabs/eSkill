...
2. Read each detected configuration file using `data_file_read` or `filesystem` `read_text`.
...
1. Determine the project language from package manifests (see security-scan Step 1 approach).
