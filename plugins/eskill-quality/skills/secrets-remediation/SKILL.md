...
- **security-scan** (eskill-quality): Run security-scan before this skill to identify the hardcoded secrets that need remediation.
- **configuration-audit** (eskill-quality): Follow up with configuration-audit after this skill to verify secrets are properly externalized to secure storage.
