...
- **refactoring-workflow** (eskill-coding): Follow up with refactoring-workflow after this skill to address the highest-priority technical debt items.
- **code-standards** (eskill-quality): Run code-standards alongside this skill to identify standards violations that contribute to technical debt.
- **dead-code-finder** (eskill-coding): Run dead-code-finder alongside this skill to include unused code in the technical debt inventory.
