...
- **context-export** (eskill-intelligence): Run context-export before this skill to gather the session context and artifacts for the transfer package.
- **codebase-cartography** (eskill-intelligence): Run codebase-cartography before this skill to include architectural maps in the knowledge transfer guide.
- **adr-generator** (eskill-office): Run adr-generator before this skill to include decision records in the knowledge transfer package.
