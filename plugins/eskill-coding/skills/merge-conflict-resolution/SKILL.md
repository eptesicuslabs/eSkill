...
Use `edit_text` from the eMCP filesystem server to make the changes.
...
- **code-review-prep** (eskill-coding): Follow up with code-review-prep after this skill to verify the conflict resolution did not introduce regressions.
- **test-scaffolding** (eskill-coding): Follow up with test-scaffolding after this skill to add tests covering the merged code paths.
