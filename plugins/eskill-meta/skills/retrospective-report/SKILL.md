...
- **session-recap** (eskill-meta): Run session-recap before this skill to collect the session summaries that feed into the retrospective.
- **project-health** (eskill-meta): Follow up with project-health after this skill to track whether retrospective action items improve project metrics.
