...
- A document or specification file (use `read_text` to load it)
...
1. **File discovery**: Use `list_directory` and `search_text` to find files related to the issue keywords
